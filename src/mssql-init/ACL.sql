...
CREATE LOGIN [flink_src] WITH PASSWORD='Abcd1234', DEFAULT_DATABASE=[master], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF;
GO
WAITFOR DELAY '00:00:02';
GO
CREATE LOGIN [flink_sink] WITH PASSWORD='Abcd1234', DEFAULT_DATABASE=[master], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF;
GO
WAITFOR DELAY '00:00:02';
GO
